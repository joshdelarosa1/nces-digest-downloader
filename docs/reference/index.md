...
Generated on: `2026-02-17 18:41:38 EST`
...
- `file_path`: Script path to update.
- `new_version`: New semantic version string.
- `new_release_date`: Release date string.
- `new_author`: Author display name.
...
- `new_version`: New semantic version string.
- `new_release_date`: Release date string.
- `new_changelog`: Changelog text for metadata block.
...
- `new_version`: New semantic version string.
- `new_release_date`: Release date string.
- `new_changelog`: Changelog text to include in tag message.
